...
<% String browser=request.getHeader("User-Agent"); boolean result=false; String type="" ; if
	...
	response.sendRedirect(request.getContextPath()+"/down/ios/html/dev-ios-download.html");
	
	} else {
	
	response.sendRedirect(request.getContextPath()+"/down/android/html/dev-android-download.html");
