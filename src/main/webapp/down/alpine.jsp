...
<% String browser=request.getHeader("User-Agent"); boolean result=false; String type="" ; if
    ...
    response.sendRedirect(request.getContextPath()+"/down/ios/html/ios-download-alpine.html");

    } else {

    response.sendRedirect(request.getContextPath()+"/down/android/html/android-download-alpine.html");
