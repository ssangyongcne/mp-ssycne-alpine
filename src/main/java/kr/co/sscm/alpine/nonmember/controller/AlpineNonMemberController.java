package kr.co.sscm.alpine.nonmember.controller;
...
import kr.co.sscm.alpine.nonmember.service.AlpineNonMemberService;
import kr.co.sscm.common.base.BaseController;

@Controller
@RequestMapping("/api/alpine")
public class AlpineNonMemberController extends BaseController {

	@Autowired
	private AlpineNonMemberService alpineNonMemberService;

	@PostMapping(value = "/nonmember/getUserList", produces = "application/json; charset=utf8")
	public @ResponseBody Map<String, Object> getUserList(@RequestBody(required = false) Map<String, Object> requestMap, HttpServletRequest httpRequest){
		...
		AlpineNonMemberRequest request = new AlpineNonMemberRequest();
		AlpineNonMemberListResponse response = alpineNonMemberService.getUserList(request);
